...
Shader::Shader(const char *vertexCode, const char *fragmentCode, bool rawCode)
{
    compileLogger.log(LogLevel::INFO, std::string("COMPILE ") + vertexCode);
    compileLogger.log(LogLevel::INFO, std::string("COMPILE ") + fragmentCode);
