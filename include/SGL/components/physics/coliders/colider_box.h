...
{
public:
    std::shared_ptr<SGL::GameObject> visObject = nullptr; ///< A shared pointer to a visual representation of the collider (optional).
    /**
    ...
    void prepare() override
    {
        ...
        // debug visualization of the colider
